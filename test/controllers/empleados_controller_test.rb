...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { club_id: @empleado.club_id, departamento_id: @empleado.departamento_id, empleado: @empleado.empleado } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { club_id: @empleado.club_id, departamento_id: @empleado.departamento_id, empleado: @empleado.empleado } }
