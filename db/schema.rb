...
ActiveRecord::Schema.define(version: 20180417202942) do

  create_table "clubes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "club"
    t.string "nombre"
  ...
  create_table "prioridades", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "prioridad"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
